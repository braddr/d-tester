...
bool validateInput(ref string raddr, ref string hostid, ref string runid, ref string type, Appender!string outstr)
{
...
void run(const ref string[string] hash, const ref string[string] userhash, Appender!string outstr)
{
    ...
    if (!validateInput(raddr, hostid, runid, type, outstr))
        return;
